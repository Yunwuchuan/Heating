...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_Temperature.setGeometry(QtCore.QRect(10, 240, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        ...
        self.lineEdit_T_SetPoint.setGeometry(QtCore.QRect(130, 240, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        ...
        self.lineEdit_P_SetPoint.setGeometry(QtCore.QRect(130, 190, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        ...
        self.label_Force_5.setGeometry(QtCore.QRect(20, 570, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        ...
        self.label_Force_2.setGeometry(QtCore.QRect(140, 570, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        self.label_Force_2.setFont(font)
        self.label_Force_2.setObjectName("label_Force_2")
        self.force_real = QtWidgets.QLineEdit(self.tab_Ctrl)
        self.force_real.setEnabled(False)
        self.force_real.setGeometry(QtCore.QRect(140, 600, 91, 31))
        ...
        self.force_real.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        self.force_real.setFont(font)
        self.force_real.setText("")
        self.force_real.setObjectName("force_real")
        self.save = QtWidgets.QPushButton(self.tab_Ctrl)
        self.save.setGeometry(QtCore.QRect(150, 490, 120, 56))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.dis_real.setGeometry(QtCore.QRect(10, 680, 91, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Text, brush)
        ...
        self.label_Force_4.setGeometry(QtCore.QRect(10, 650, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        self.label_Force_4.setFont(font)
        self.label_Force_4.setObjectName("label_Force_4")
        self.temp_real = QtWidgets.QLineEdit(self.tab_Ctrl)
        self.temp_real.setEnabled(False)
        self.temp_real.setGeometry(QtCore.QRect(10, 600, 91, 31))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.PlaceholderText, brush)
        self.temp_real.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        self.temp_real.setFont(font)
        self.temp_real.setText("")
        self.temp_real.setClearButtonEnabled(False)
        self.temp_real.setObjectName("temp_real")
        self.p_cali = QtWidgets.QPushButton(self.tab_Ctrl)
        self.p_cali.setGeometry(QtCore.QRect(10, 490, 120, 56))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.p_cali.sizePolicy().hasHeightForWidth())
        self.p_cali.setSizePolicy(sizePolicy)
        self.p_cali.setMinimumSize(QtCore.QSize(56, 56))
        self.p_cali.setMaximumSize(QtCore.QSize(120, 201))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(22)
        self.p_cali.setFont(font)
        self.p_cali.setObjectName("p_cali")
...
"串口"))
        ...
        self.label_Force_5.setText(_translate("MainWindow", "Temp"))
        self.label_Force_2.setText(_translate("MainWindow", "Force"))
        self.save.setText(_translate("MainWindow", "Save"))
        self.label_Force_4.setText(_translate("MainWindow", "Dis"))
        self.p_cali.setText(_translate("MainWindow", "P Cal"))
