...
class Binding(QWidget):
    def __init__(self, ui, mainwindow):
        ...
        self.ui.label_T_Kp.setText("0")
        self.ui.label_T_Ti.setText("0")
        self.ui.label_T_Td.setText("0")
        self.ui.label_F_Kp.setText("0")
        self.ui.label_F_Ti.setText("0")
        self.ui.label_F_Td.setText("0")
        self.ui.label_P_Kp.setText("0")
        self.ui.label_P_Ti.setText("0")
        self.ui.label_P_Td.setText("0")
    ...
    def openSerial(self):
        if self.ui.open_serial.isChecked():
            ...
            gl.mainserial = Myserial(self.ui.port_select.currentText().split(" ")[0], \
                                         int(self.ui.baund_rate.currentText()), timeout=None, textbox=self.ui.textBrowser_RecText, queue=gl.queue1)
    ...
    def send(self):
        try:
            ...
            t_Kp = int(10*float(self.ui.label_T_Kp.text()))
            t_Ti = int(10*float(self.ui.label_T_Ti.text()))
            t_Td = int(100*float(self.ui.label_T_Td.text()))
            f_Kp = int(10*float(self.ui.label_F_Kp.text()))
            f_Ti = int(10*float(self.ui.label_F_Ti.text()))
            f_Td = int(100*float(self.ui.label_F_Td.text()))
            p_Kp = int(10*float(self.ui.label_P_Kp.text()))
            p_Ti = int(10*float(self.ui.label_P_Ti.text()))
            p_Td = int(100*float(self.ui.label_P_Td.text()))
